...
import { WpAddonDetailComponent } from './detail';
import { DynamicDialogConfig } from 'primeng/dynamicdialog';
import { HttpClient } from '@angular/common/http';


@Component({
    selector: 'wp_addon-list',
    standalone: true,
    imports: [CommonModule, TableModule, ButtonModule, TagModule, Toolbar, WpAddonDetailComponent, TranslatePipe],
    template: `
        ...
        <wp_addon-detail *ngIf="config?.data?.mode !== 'lookup'"></wp_addon-detail>
    `
})
export class WpAddonListComponent {
