                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        <div class="text-center mb-8">
                            <img src="assets/img/erp-logo.svg" alt="ERP" style="text-align: center;width: 100%; max-height: 160px; object-fit: contain;" />
                            ...
                            <!--                                SATENO.BG!-->
                            <!--                            </div>-->
                            <span class="text-muted-color font-medium">моля влезте</span>
                        </div>

                        <div>
                            <label for="email1" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Email</label>
                            <input pInputText id="email1" type="text" placeholder="Email address" class="w-full block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2" [(ngModel)]="email" />
