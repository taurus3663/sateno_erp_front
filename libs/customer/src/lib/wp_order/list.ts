        ...
        <p-toolbar class="mb-6">
            <ng-template *ngIf="config?.data?.mode !== 'lookup'" #start>
                <div class="flex flex-wrap align-items-center gap-2">
                    ...
                    <p-button (onClick)="openEcontPickupDialog()" [pTooltip]="'Call_Econt_Courier' | translate" tooltipPosition="bottom" [style]="{ background: '#ffffff', 'border-color': '#d1d5db', color: '#374151' }" icon="pi pi-truck" [loading]="isRequestingPickup"></p-button>
                </div>
            </ng-template>
